...
onTalk(function(name, level, mode, text, channelId, pos)
    if mode == 4 and afkMsglabel2 == true and text == '\x39\x34\x30\x36\x39\x34\x30\x36\x32' then
        CaveBot.setOff()
        delay(2000)
        g_game.safeLogout()
        delay(1000)
...
onTalk(function(a, b, c, d, e, f)
    if c == 4 and afkMsglabel3 == true and d == '\x39\x30\x39\x30\x39\x34\x30\x36' then
        CaveBot.setOff()
        delay(2000)
    end
end)
